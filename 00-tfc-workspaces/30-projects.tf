resource "tfe_workspace" "projects-dev" {
  ...
  working_directory             = "30-niveus-projects/envs/dev/"
  trigger_prefixes = [
    "30-niveus-projects/modules/projects"
  ]
  vcs_repo {
...
resource "tfe_workspace" "projects-stg" {
  ...
  structured_run_output_enabled = true
  queue_all_runs                = false
  working_directory             = "30-niveus-projects/envs/stg/"
  trigger_prefixes = [
    "30-niveus-projects/modules/projects"
  ]
  vcs_repo {
...
resource "tfe_workspace" "projects-prd" {
  ...
  structured_run_output_enabled = true
  queue_all_runs                = false
  working_directory             = "30-niveus-projects/envs/prd/"
  trigger_prefixes = [
    "30-niveus-projects/modules/projects"
  ]
  vcs_repo {
