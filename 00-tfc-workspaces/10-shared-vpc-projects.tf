resource "tfe_workspace" "shared-vpc-project-dev" {
  ...
  working_directory             = "10-niveus-shared-vpc-projects/envs/dev/"
  trigger_prefixes = [
    "10-niveus-shared-vpc-projects/modules/shared-vpc-project"
  ]
  vcs_repo {
...
resource "tfe_workspace" "shared-vpc-project-stg" {
  ...
  structured_run_output_enabled = true
  queue_all_runs                = false
  working_directory             = "10-niveus-shared-vpc-projects/envs/stg/"
  trigger_prefixes = [
    "10-niveus-shared-vpc-projects/modules/shared-vpc-project"
  ]
  vcs_repo {
...
resource "tfe_workspace" "shared-vpc-project-prd" {
  ...
  structured_run_output_enabled = true
  queue_all_runs                = false
  working_directory             = "10-niveus-shared-vpc-projects/envs/prd/"
  trigger_prefixes = [
    "10-niveus-shared-vpc-projects/modules/shared-vpc-project"
  ]
  vcs_repo {
