resource "tfe_workspace" "shared-vpc-networking-dev" {
  ...
  working_directory             = "20-niveus-shared-vpc-networking/envs/dev/"
  trigger_prefixes = [
    "20-niveus-shared-vpc-networking/modules/networking"
  ]
  vcs_repo {
...
resource "tfe_workspace" "shared-vpc-networking-stg" {
  ...
  structured_run_output_enabled = true
  queue_all_runs                = false
  working_directory             = "20-niveus-shared-vpc-networking/envs/stg/"
  trigger_prefixes = [
    "20-niveus-shared-vpc-networking/modules/networking"
  ]
  vcs_repo {
...
resource "tfe_workspace" "shared-vpc-networking-prd" {
  ...
  structured_run_output_enabled = true
  queue_all_runs                = false
  working_directory             = "20-niveus-shared-vpc-networking/envs/prd/"
  trigger_prefixes = [
    "20-niveus-shared-vpc-networking/modules/networking"
  ]
  vcs_repo {
